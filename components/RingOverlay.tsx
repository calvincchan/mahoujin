  ...
  return (
    ...
    >
      <svg
        ...
        aria-hidden
      >
        <circle cx={CX} cy={CY} r={R1} fill="none" stroke="var(--color-theme)" strokeWidth={0.4} />
        <circle cx={CX} cy={CY} r={R2} fill="none" stroke="var(--color-theme)" strokeWidth={0.25} strokeDasharray="1 2" />
